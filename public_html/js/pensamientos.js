var density = 20,
		speed = 1,
		winHeight = $(".BarreraNumeros").height(),
		...
		colors = ["#009b00","#FFFFFF","#dc0000","#009b00","#FFFFFF","#dc0000"];
	...
	function spawn(particle) {
	 ...
	 $('.tapa').click(function() {
		var body = $(".BarreraNumeros"),
			i, particle;
		for (i = 0; i < density; i++) {
			spawn( $("<div />", {id:"particle"+i}).addClass("particle").text( Math.round( Math.random() * 0 )).appendTo(body) );
		}
	});